    ...
    <div className="flex flex-col w-full md:w-72 mx-6 md:mx-0  transform overflow-hidden bg-white dark:bg-slate-800 shadow-md hover:shadow-lg border border-gray-200 duration-300">
      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        <div className="flex mt-auto items-center">
          <p className="mr-2 text-xl font-semibold text-sky-900 dark:text-white">₱{product.newPrice.toLocaleString()}</p>
          <p className="text-sm font-medium text-sky-950 line-through dark:text-gray-300">₱{product.oldPrice.toLocaleString()}</p>
        </div>
      </div>
    </div>
  );
